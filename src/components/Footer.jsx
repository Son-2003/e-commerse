  ...
  return (
    <>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>
            <div>
                <p className='text-5xl mb-5 w-40 font-gallisia'>Mei Ling</p>
            ...
            <div>
                ...
                <ul className='flex flex-col gap-1 text-gray-600'>
                    ...
                    <li><Link to={"https://www.instagram.com/ducson_29/"}>Instagram</Link></li>
                </ul>
            </div>
        ...
        <div>
            <hr/>
            <p className='my-5 text-sm text-center'>Copyright 2024@MEILING.com - All Right Reserved.</p>
        </div>
    </>
