    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className={`absolute top-0 right-0 bottom-0 transition-all bg-white ${visible ? 'w-full' : 'w-0 hidden'}`}>
            <div className='flex flex-col text-gray-600'>
                ...
                <NavLink onClick={() => setVisible(false)} on  to='/' className="py-2 pl-6 border-b-2">HOME</NavLink>
                <NavLink onClick={() => setVisible(false)} to='/collection' className="py-2 pl-6 border-b-2">COLLECTION</NavLink>
                <NavLink onClick={() => setVisible(false)} to='/about' className="py-2 pl-6 border-b-2">ABOUT</NavLink>
                <NavLink onClick={() => setVisible(false)} to='/contact' className="py-2 pl-6 border-b-2">CONTACT</NavLink>   
            </div>
        </div>
