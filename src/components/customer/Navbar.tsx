...
const Navbar = () => {
  ...
  return (
    <nav
      className={`px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] w-full bg-white z-50 transition-all duration-500
    ${
      location.pathname === "/"
        ? `fixed top-0 left-0 ${
            show
        ...
        <div className="flex items-center gap-6 w-1/3 justify-end">
          ...
          {userInfo && (
            <MessageOutlined
              ...
              className="text-xl text-black/80 cursor-pointer"
            />
          )}
                  ...
                  <div className="flex flex-col bg-white rounded-sm overflow-hidden border border-gray-100">
                    ...
                    <div className="flex flex-col">
                      <button
                        ...
                        onClick={() => handleClick("profile/info")}
                      >
                        My Info
                      </button>
                      <button
