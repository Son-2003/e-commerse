...
const Collection = () => {
  ...
  const sortProducts = () => {
    let productSort = products.slice();

    switch(sortType){ 
        case "low-high":
          setFilterProducts(productSort.sort((a,b) => (a.price - b.price)))
          break;
        case "high-low":
          setFilterProducts(productSort.sort((a,b) => (b.price - a.price)))
          break;
        default:
          applyFilter();
          break;
