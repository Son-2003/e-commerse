...
const Profile = () => {
  ...
  return (
    <div className="flex items-start justify-center py-5 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-6xl bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 grid grid-cols-1 lg:grid-cols-4">
          ...
          <nav className="p-6 space-y-3">
            ...
            >
              <UserOutlined className={`text-lg ${
                activeTab === "profile" ? "text-white" : "text-gray-400 group-hover:text-gray-600"
              }`} />
            ...
            >
              <ShoppingOutlined className={`text-lg ${
                activeTab === "orders" ? "text-white" : "text-gray-400 group-hover:text-gray-600"
              }`} />
            ...
            <div className="pt-4 border-t border-gray-200">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left text-red-600 hover:bg-red-50 hover:text-red-700 transition-all duration-200 group"
              >
        ...
        <main className="lg:col-span-3 p-8">
          ...
          {activeTab === "profile" && (
            <>
              <div className="w-full bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-8 mb-8 border border-blue-100 shadow-sm">
              ...
              <div className="w-full bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-8 mb-8 border border-blue-100 shadow-sm">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  ...
                  <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
                    ...
                    <span className="text-sm font-medium text-gray-700">24 Orders</span>
                  </div>
                </div>
              </div>
